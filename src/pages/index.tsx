        ...
        <main className='px-[20px] max-w-[1400px]'>
          ...
          <section className='flex flex-col items-center section-spacer lg:flex-row lg:items-start'>
            ...
            <div className='lg:grow-0 lg:basis-[45%] lg:mt-[0] mt-[15px] flex flex-col justify-between align-center px-[10px] '>
              <h2 className='text-center lg:text-left section-header mb-[15px]'>
                {t("for")}
              </h2>
              <p className='text-xl my-1 text-left'>{t("more_1")}</p>
              <p className='text-xl mt-1 text-left'>{t("more_2")}</p>
            </div>
          </section>
